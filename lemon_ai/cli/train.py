...
def train_command(
    ...
    try:
        # 导入训练模块
        from lemon_ai.training.trainer import Trainer, TrainerConfig
        from lemon_ai.shared.config import AtguiguConfig
        ...
        if dry_run:
            ...
            from lemon_ai.dialogue_understanding.flow import FlowLoader
